...
const string strMessageMagic = "Capricoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t StakePercent = 0.02 * COIN;

    StakePercent >>= (pindexBest->nHeight / YEARLY_BLOCKCOUNT);
    
    nRewardCoinYear = StakePercent;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Capricoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Fri, 03 Jul 2015 17:43:24 GMT";
        CTransaction txNew;
        txNew.nTime = 1435945404;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7998a66c32290ca3c0dae0370dc824292145978af0f5e04d82bad3a17084336c"));
        block.print();
